...
ADAM_PRO_XML = Path(__file__).parent / "adam_pro.xml"
assert ADAM_PRO_XML.exists()
...
def get_assets(meshdir: str) -> dict[str, bytes]:
  ...
  update_assets(assets, ADAM_PRO_XML.parent / meshdir_clean, meshdir_clean)
  return assets
...
##
# Motor specs (from ADAM_PRO.py).
##

ARMATURE_130_92_7_P = 0.13426  # hip pitch, knee pitch
ARMATURE_50_14A_50_S = 0.1578807 # shoulder pitch, shoulder roll
...
ARMATURE_50_52_30_P = 0.0549 # ankle pitch, ankle roll
...
ADAM_PRO_ACT_FEET_PITCH = BuiltinPositionActuatorCfg(
...
ADAM_PRO_ACT_FEET_ROLL = BuiltinPositionActuatorCfg(
...
ADAM_PRO_ACT_WAIST = BuiltinPositionActuatorCfg(
...
ADAM_PRO_ARTICULATION = EntityArticulationInfoCfg(
  actuators=(
    ...
    ADAM_PRO_ACT_FEET_PITCH,
    ADAM_PRO_ACT_FEET_ROLL,
    ADAM_PRO_ACT_WAIST,
